...
vsim -t ns -voptargs=+acc work.tb_tx_rx_control

############################## 添加波形模板#############################
# 添加虚拟类型
#添加波形区分说明
add wave -divider {tb_tx_rx_control} 
#添加波形
add wave tb_tx_rx_control/*
add wave -divider {tx_rx_control} 
add wave tx_rx_control_inst/*
